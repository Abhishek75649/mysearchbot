...
class Config(object):
    ...
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001852493441")) 
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    ...
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://Abhigupta77:<omprtngslb>@cluster0.ccb8umw.mongodb.net/?retryWrites=true&w=majority")
